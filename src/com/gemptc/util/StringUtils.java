...
public class StringUtils {
	/*public static boolean registerCheck(Context context, EditText et_phone,EditText et_code,
	...
	public static boolean VerGoodsInfo(Context context,EditText et_title,EditText et_subtitle,EditText et_price,TextView tv_type){
