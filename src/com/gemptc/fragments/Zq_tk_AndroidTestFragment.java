 ...
 *
 */
public class Zq_tk_AndroidTestFragment extends Fragment implements OnClickListener {
	private View view;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.zq_tk_androidtest, container, false);
		findViewId();
		listener();
