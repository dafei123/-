...
import com.gemptc.fragments.Zq_FragmentAdapter;
...
public class Zq_Tk_main extends FragmentActivity implements OnClickListener {
	    ...
	    protected void onCreate(Bundle savedInstanceState) {
			...
			setContentView(R.layout.zq_tk_main);
	        findView();
			addListener();
	    }
	    ...
	    private void findView() {
			...
			viewPager.setAdapter(new Zq_FragmentAdapter(getSupportFragmentManager()));
		}
		...
		public boolean onMenuOpened(int featureId, Menu menu) {
			...
			//menuWindow = new SelectPicPopupWindow(Zq_Tk_main.this, itemsOnClick);
			//显示窗口
