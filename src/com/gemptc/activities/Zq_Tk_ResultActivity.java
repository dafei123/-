 ...
 *
 */
public class Zq_Tk_ResultActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.zq_tk_result);
		findViewId();
		getResult();
		init();
		Listener();
	...
	private void findViewId() {
		ivtk=(ImageView) findViewById(R.id.ivtk);
		ivtk.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				Zq_Tk_ResultActivity.this.finish();
			}
		});
	...
	private OnClickListener buttonListener = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			if(v==show_result) {
				...
				Intent intent = new Intent(getApplicationContext(),Zq_Tk_main.class);
