...
public class Zq_zl_et4Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.zq_zl_et4);
	...
	private void init() {
		...
		linword.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(Zq_zl_et4Activity.this,
		...
		linsentence.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent intent1 = new Intent(Zq_zl_et4Activity.this,
